...
export const EXPERIENCE = [
  ...
  },
  {
    ...
    points: [
      "TA for Deep Learning for Perception, where I graded assignments, ran office hours, and assisted 60+ students with PyTorch implementations",
      "Lab Assistant for Programming Fundamentals, guiding freshmen through C language labs, debugging sessions, and exam preparation",
    ],
  },
];
